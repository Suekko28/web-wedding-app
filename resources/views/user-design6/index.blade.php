    ...
    <main>
        <div class="container-xxl flex-grow-1 container-p-y">
            <a class="btn btn-primary mb-3"
                href="{{ route('nama-undangan-create6', [
                    'id' => $weddingDesign6->id, // This is the weddingDesign6 ID (e.g., 2)
                ]) }}">
                + Nama Undangan
            </a>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive text-nowrap p-3">
                        <form id="deleteForm" action="{{ route('nama-undangan.destroy6', ['id' => $weddingDesign6->id]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        function updateMessage(radioButton, namaUndangan, itemId) {
            ...
            if (radioButton === '1') {
                message = "Assalamu'alaikum Wr. Wb\n" +
                    ...
                    "jejakkebahagiaan.com/{{ $weddingDesign6->nama_mempelai_laki }}&{{ $weddingDesign6->nama_mempelai_perempuan }}/teruntuk=" +
                    namaUndangan + "\n\n" +
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        document.getElementById('deleteForm').action =
                            "{{ route('nama-undangan.destroy6', ['id' => ':id']) }}".replace(':id',
                                itemId);
