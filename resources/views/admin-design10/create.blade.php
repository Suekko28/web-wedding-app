...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Create', 'subtitle' => 'Wedding Design 10'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('form-design10.store', ['id' => $informasiDesign10Id]) }}" method="post"
                            ...
                            <div class="form-group form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="file" accept="image/*" class="form-control" id="image_hero"
                                ...
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="judul_quote" name="judul_quote"
                                            placeholder="Masukkan Quote" value="{{ old(key: 'judul_quote') }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="deskripsi_quote">Deskripsi Quote<span class="fst-italic">
                                                (Opsional)</span></label>
                                        <textarea class="form-control" rows="5" id="deskripsi_quote" name="deskripsi_quote" placeholder="Deskripsi">{{ old('deskripsi_quote') }}</textarea>
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="link_cinta" name="link_cinta"
                                            placeholder="Masukkan link video" value="{{ old('link_cinta') }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="youtube_streaming" name="youtube_streaming"
                                            placeholder="Masukkan link" value="{{ old('youtube_streaming') }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="zoom_streaming">Streaming Zoom<span class="fst-italic">
                                                (Opsional)</span></label>
                                        <input type="text" class="form-control" id="link_zoom" name="zoom_streaming"
                                            placeholder="Masukkan link" value="{{ old('zoom_streaming') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formDresscode"
                        action="{{ route('dresscode-design10.store', ['id' => $informasiDesign10->id]) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
