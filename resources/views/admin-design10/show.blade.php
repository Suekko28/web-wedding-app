...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Show', 'subtitle' => 'Wedding Design 10'])
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form
                        ...
                        @csrf
                        @method('PUT')
                        <input disabled type="hidden" name="informasi_design10_id" value="{{ $informasiDesign10->id }}">
                        <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign10->nama_pasangan }}">
                        <input disabled type="hidden" name="tgl_pernikahan"
                            value="{{ $informasiDesign10->tgl_pernikahan }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="nama_pasangan"
                                            ...
                                            value="{{ $informasiDesign10->nama_pasangan }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="file" class="form-control" id="image_hero"
                                            name="image_hero[]" multiple>
                                        @if ($data->image_hero)
                                ...
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        <label for="judul_quote">Judul Quote <span class="fst-italic">
                                                (Opsional)</span></label>
                                        <input disabled type="text" class="form-control" id="judul_quote"
                                            name="judul_quote" placeholder="Masukkan Quote"
                                            value="{{ $data->judul_quote }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="deskripsi_quote">Deskripsi Quote<span class="fst-italic">
                                                (Opsional)</span></label>
                                        <textarea disabled class="form-control" rows="5" id="deskripsi_quote"
                                            name="deskripsi_quote" placeholder="Deskripsi">{{ $data->deskripsi_quote }}</textarea disabled>
                                        </div>
                                        <div class="col-sm-4 mb-3">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <textarea disabled class="form-control" rows="5" id="deskripsi_pembuka" name="deskripsi_pembuka"
                                                placeholder="Deskripsi">{{ old('deskripsi_pembuka', $data->deskripsi_pembuka ?? $defaultDeskripsiPembuka) }}</textarea disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="link_cinta">Link Video<span class="fst-italic">
                                                    (Opsional)</span></label>
                                            <input disabled type="text" class="form-control" id="link_cinta" name="link_cinta"
                                ...
                                <div class="form-group fs-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <select class="form-control"  disabled name="zona_waktu_akad" id="zona_waktu_akad">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="zona_waktu_resepsi">Zona Waktu <span
                                                    class="mandatory">*</span></label>
                                            <select class="form-control"  disabled name="zona_waktu_resepsi" id="zona_waktu_resepsi">
                                                <option value="0" disabled
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 mb-3">
                                            <label for="instagram_streaming">Streaming Instagram<span class="fst-italic">
                                                    (Opsional)</span></label>
                                            <input disabled type="text" class="form-control" id="instagram_streaming"
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="youtube_streaming">Streaming Youtube<span class="fst-italic">
                                                    (Opsional)</span></label>
                                            <input disabled type="text" class="form-control" id="youtube_streaming" name="youtube_streaming"
                                                placeholder="Masukkan link" value="{{ $data->youtube_streaming }}">
                                        </div>
                                        <div class="col-sm-4 mb-3">
                                            <label for="zoom_streaming">Streaming Zoom<span class="fst-italic">
                                                    (Opsional)</span></label>
                                            <input disabled type="text" class="form-control" id="zoom_streaming" name="zoom_streaming"
                                ...
                                <div class="form-group form-group fs-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <input disabled type="text" class="form-control" id="nama_penutup" name="nama_penutup"
    ...
    @endforeach
        ...
        <div class="d-flex flex-row-reverse">
            <a href="{{ route('wedding-design10.index') }}" class="btn btn-secondary">Kembali</a>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formDirectTransfer"
                            ...
                            <input disabled type="hidden" name="wedding_design10_id" value="{{ $informasiDesign10->id }}">
                            <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign10->nama_pasangan }}">
                            <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign10->tgl_pernikahan }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formDresscode"
                            ...
                            method="POST" enctype="multipart/form-data">
                            @csrf
                            <input disabled type="hidden" name="_method" id="formMethodDresscode" value="POST">
                            <input disabled type="hidden" name="DresscodeId" id="DresscodeId">
                            <input disabled type="hidden" name="wedding_design10_id" value="{{ $informasiDesign10->id }}">
                            <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign10->nama_pasangan }}">
                            <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign10->tgl_pernikahan }}">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input disabled type="file" name="image" id="image" class="form-control" accept="image/*">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input disabled type="text" name="judul_dresscode" id="judul_dresscode" class="form-control"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <textarea disabled class="form-control" rows="10" id="deskripsi_dresscode" name="deskripsi_dresscode"
                                    placeholder="Masukkan isi deskripsi">{{ old('deskripsi_dresscode') }}</textarea disabled>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
