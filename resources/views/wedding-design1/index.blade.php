...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/home-aldi.css') }}" />
    <link rel="stylesheet"
    ...
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Cormorant:ital,wght@0,400;0,500;0,700;1,700&display=swap" />
...
<body>
    <div class="home5">
        <section class="banner6" data-scroll-to="HeaderSection">
            <div class="rectangle">
                ...
                <div class="navbar-mobile3">
                    <div class="button56" id="buttonContainer">
                        <img class="icon-home3" loading="lazy" alt=""
                            src="{{ asset('./assets/icon-home.svg') }}" />
                    </div>
                    <div class="button57" id="buttonContainer1">
                        <img class="icon-rings3" loading="lazy" alt=""
                            src="{{ asset('./assets/icon-rings.svg') }}" />
                    </div>
                    <div class="button58" id="buttonContainer2">
            ...
            <button class="floating-button4" id="floatingButton">
                ...
                <img class="play-icon" alt="" src="{{ asset('./assets/PiringanImg.png') }}" />
                <img class="pause-1-icon" alt="" src="{{ asset('./assets/Piringan.gif') }}" />
            </button>

        </section>

        <section class="mempelai6" data-scroll-to="mempelai">
            <h1 class="mempelai7">Mempelai</h1>
        ...
        <section class="jadwal-wrapper">
            <div class="jadwal9">
                <div class="jadwal10" data-scroll-to="jadwalContainer">
                    <div class="jadwal11">
                        ...
                        <img class="story-frame-icon" loading="lazy" alt=""
                            src="{{ asset('./assets/frame.svg') }}" />
                        <div class="text-frame2">
                            <div class="resepsi-parent3">
                    ...
                    <img class="asset-2-53" loading="lazy" alt=""
                        src="{{ asset('./assets/asset-2-5@2x.png') }}" />
                    <img class="asset-2-63" loading="lazy" alt=""
                        src="{{ asset('./assets/asset-2-6@2x.png') }}" />
                </div>
            </div>
        </section>


        {{-- <div class="r-s-v-p-frame">
            
            <div class="ucapan-mobile-label">
                <img class="r-s-v-p-caption" loading="lazy" alt=""
                    src="{{ asset('./assets/frame-1042@2x.png') }}" />

                <div class="mobile-r-s-v-p1">
                    <div class="card-list16">
                        <h1 class="galeri3">Galeri</h1>
                    </div>
                    <div class="frame-parent149">
                        <img class="frame-child44" loading="lazy" alt=""
                            src="{{ asset('./assets/frame-992@2x.png') }}" />
                        <img class="frame-child45" loading="lazy" alt=""
                            src="{{ asset('./assets/frame-1002@2x.png') }}" />
                        <img class="frame-child46" loading="lazy" alt=""
                            src="{{ asset('./assets/frame-1012@2x.png') }}" />
                    </div>
                    <div class="frame-parent150">
                        <img class="frame-child47" loading="lazy" alt=""
                            src="{{ asset('./assets/frame-1032@2x.png') }}" />
                        <img class="frame-child48" loading="lazy" alt=""
                            src="{{ asset('./assets/frame-1022@2x.png') }}" />
                    </div>
                </div>
            </div>
        </div> --}}
    ...
    <section class="rsvp5" data-scroll-to="rSVP">
        <form class="rsvp-mobile3" method="POST"
            action="{{ route('wedding-design1-post', [
    ...
    <script>
        ...
        if (buttonContainer1) {
            buttonContainer1.addEventListener("click", function() {
                var anchor = document.querySelector("[data-scroll-to='mempelai']");
                if (anchor) {
                    anchor.scrollIntoView({
                        block: "start",
                        behavior: "smooth"
        ...
        if (buttonContainer2) {
            buttonContainer2.addEventListener("click", function() {
                var anchor = document.querySelector("[data-scroll-to='jadwalContainer']");
                if (anchor) {
                    anchor.scrollIntoView({
                        block: "start",
                        behavior: "smooth"
        ...
        if (buttonContainer3) {
            buttonContainer3.addEventListener("click", function() {
                var anchor = document.querySelector("[data-scroll-to='rSVP']");
                if (anchor) {
                    anchor.scrollIntoView({
                        block: "start",
                        behavior: "smooth"
        ...
        if (buttonContainer4) {
            buttonContainer4.addEventListener("click", function() {
                var anchor = document.querySelector("[data-scroll-to='hadiah']");
                if (anchor) {
                    anchor.scrollIntoView({
                        block: "start",
                        behavior: "smooth"
