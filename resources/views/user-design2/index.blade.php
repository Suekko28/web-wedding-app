            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive text-nowrap p-3">
                        <form id="deleteForm" action="{{ route('nama-undangan.destroy2', ['id' => $weddingDesign2->id]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
        ...
        function updateMessage(radioButton, namaUndangan, itemId) {
            ...
            if (radioButton === '1') {
                message = "Assalamu'alaikum Wr. Wb\n" +
                    ...
                    "jejakkebahagiaan.com/{{ $weddingDesign2->nama_mempelai_laki }}&{{ $weddingDesign2->nama_mempelai_perempuan }}/untuk=" +
                    namaUndangan + "\n\n" +
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        document.getElementById('deleteForm').action =
                            "{{ route('nama-undangan.destroy2', ['id' => ':id']) }}".replace(':id',
                                itemId);
