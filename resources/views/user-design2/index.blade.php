...
@section('pageContent')
    ...
    <main>
        <div class="container-xxl flex-grow-1 container-p-y">
            <a class="btn btn-primary mb-3" href="{{ route('nama-undangan-create', ['id' => $weddingDesign2->id]) }}">+
                Nama
                Undangan</a>
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap p-3">
                    <form id="deleteForm" action="{{ route('nama-undangan.destroy', ['id' => $weddingDesign2->id]) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        {{-- <button class="btn btn-primary"
                                            onclick="copyLink('{{ $item->id }}', '{{ $weddingDesign2->nama_mempelai_laki }}', '{{ $weddingDesign2->nama_mempelai_perempuan }}', '{{ $item->nama_undangan }}')">
        ...
        function updateMessage(radioButton, namaUndangan, itemId) {
            ...
            if (radioButton === '1') {
                message = "Assalamu'alaikum Wr. Wb\n" +
                    ...
                    "jejakkebahagiaan.com/{{ $weddingDesign2->nama_mempelai_laki }}&{{ $weddingDesign2->nama_mempelai_perempuan }}/=" +
                    namaUndangan + "\n\n" +
