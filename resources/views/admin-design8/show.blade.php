                ...
                <div class="container-fluid">
                    ...
                    <form
                        ...
                        <input disabled type="hidden" name="tgl_pernikahan"
                            value="{{ $informasiDesign8->tgl_pernikahan }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="nama_pasangan"
                                            ...
                                            value="{{ $informasiDesign8->nama_pasangan }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="image_cinta">Upload Images<span class="fst-italic">
                                                (Opsional)</span></label>
                                            <input disabled type="file" class="form-control" id="image_cinta" name="image_cinta[]"
                                                multiple>
                                            @if ($data->image_cinta)
                        ...
                        <form id="formDirectTransfer"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input disabled type="number" name="no_rek" id="no_rek" class="form-control"
                                    value="{{ old('no_rek') }}" placeholder="181293912">
                            </div>
