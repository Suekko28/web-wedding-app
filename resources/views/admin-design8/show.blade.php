        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form
                        action="{{ route('form-design8.update', ['informasiDesign8Id' => $data->informasi_design8_id, 'id' => $data->id]) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input disabled type="hidden" name="informasi_design8_id" value="{{ $informasiDesign8->id }}">
                        <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign8->nama_pasangan }}">
                        <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign8->tgl_pernikahan }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="nama_pasangan" name="nama_pasangan"
                                            placeholder="" disabled value="{{ $informasiDesign8->nama_pasangan }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="tgl_pernikahan" name="tgl_pernikahan"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($informasiDesign8->tgl_pernikahan)->format('d-m-Y') }}">
                                    </div>
                                    <div class="col-sm-4">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formDirectTransfer"
                        action="{{ route('directtransfer-design8.store', ['id' => $informasiDesign8->id]) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input disabled type="hidden" name="wedding_design8_id" value="{{ $informasiDesign8->id }}">
                        <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign8->nama_pasangan }}">
                        <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign8->tgl_pernikahan }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formKirimHadiah"
                        action="{{ route('kirimhadiah-design8.store', ['id' => $informasiDesign8->id]) }}" method="POST"
    ...
    <script>
        ...
        $('#btnDirectTransfer').on('click', function() {
            ...
            $('#formDirectTransfer').attr('action',
                '{{ route('directtransfer-design8.store', ['id' => $informasiDesign8->id]) }}');
        ...
        $(document).on('click', '.delete-btn-direct-transfer', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('/wedding-design8') }}/" + id + "/delete-direct-transfer",
                        type: 'DELETE',
                        data: {
    ...
    <script>
        ...
        $('#btnKirimHadiah').on('click', function() {
            ...
            $('#formKirimHadiah').attr('action',
                '{{ route('kirimhadiah-design8.store', ['id' => $informasiDesign8->id]) }}');
        ...
        $(document).on('click', '.delete-btn-kirim-hadiah', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('/wedding-design8') }}/" + id + "/delete-kirim-hadiah",
                        type: 'DELETE',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content')
                        },
