...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Create', 'subtitle' => 'Wedding Design 8'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('form-design8.store', ['id' => $informasiDesign8Id]) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="informasi_design8_id" value="{{ $informasiDesign8->id }}">
                        <input type="hidden" name="nama_pasangan" value="{{ $informasiDesign8->nama_pasangan }}">
                        <input type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign8->tgl_pernikahan }}">
                        ...
                        <div class="d-flex flex-row-reverse">
                            ...
                            <a href="{{ route('wedding-design8.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formDirectTransfer"
                        ...
                        <input type="hidden" name="wedding_design8_id" value="{{ $informasiDesign8->id }}">
                        <input type="hidden" name="nama_pasangan" value="{{ $informasiDesign8->nama_pasangan }}">
                        <input type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign8->tgl_pernikahan }}">
