...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Cetak Foto', 'subtitle' => 'Dashboard'])
    <div class="card w-100 position-relative overflow-hidden">
        {{-- <div class="px-4 py-3 border-bottom">
            <h4 class="card-title mb-0">Basic Table</h4>
        </div> --}}
        <div class="card-body">
            <a class="btn btn-primary mb-3" href="{{ url('cetakfoto/create') }}">+ Produk</a>
                        ...
                        @foreach ($data as $item)
                            <tr class="text-center">
                                {{-- <td><input type="checkbox" class="delete-checkbox" name="selected[]"
                                        value="{{ $item->id }}"></td> --}}
                                <td scope="row">{{ $i }}</td>
                                <td scope="row">{{ $item->id_cetakfoto }}</td>
                                ...
                                <td>
                                    <img class="img-fluid" src="{{ asset('storage/cetakfoto/' . $item->image) }}"
                                        alt="" width="120" height="120" alt="Foto cetakfoto">
                                </td>
                                <td>{{ $item->judul }} </td>
