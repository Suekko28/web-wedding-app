...
<head>
    ...
    <!-- CSS STYLE -->
    <link href="{{ asset('css/wedding-design4.css') }}?v={{ filemtime(public_path('css/wedding-design4.css')) }}" rel="stylesheet" />
                        ...
                        <div class="info">
                            ...
                            <div class="detail-info">
                                <span class="label">
                                    ...
                                    {{ \Carbon\Carbon::parse($data->selesai_akad)->format('H:i') }} @if ($data->zona_waktu_akad == 1)
                                        WIB
