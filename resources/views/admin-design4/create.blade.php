                        ...
                        <div class="card-body container bg-white">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="quote_img">Upload Images <span class="fst-italic">
                                                    (Opsional)</span></label>
                                            <input type="file" accept="image/*" class="form-control" id="quote_img"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            <label for="zona_waktu_resepsi">Zona Waktu <span
                                                    class="mandatory">*</span></label>
                                            <select class="form-control" name="zona_waktu_resepsi"
                                                id="zona_waktu_resepsi">
                                                <option value="" disabled selected>--Pilih Zona Waktu--</option>
                                                @foreach ($zonaWaktuOptions as $key => $label)
                                                    <option value="{{ $key }}"
                            ...
                            <div class="card-body container bg-white">
                                ...
                                <div class="form-group form-group fs-3">
                                    <div class="row">
                                        <div class="col-sm-4 mb-3">
                                            <label for="deskripsi_penutup">Deskripsi<span
                                                    class="mandatory">*</span></label>
