        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <form
                            action="{{ route('nama-undangan-update7', ['weddingDesign7Id' => $weddingDesign7Id, 'id' => $data->id]) }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="wedding_design7_id" value="{{ $weddingDesign7->id }}">
                            <div class="card-body container bg-white mt-5">
                                ...
                                <div class="d-flex flex-row-reverse mt-5">
                                    ...
                                    <a href="{{ route('nama-undangan-list7', ['weddingDesign7Id' => $weddingDesign7->id]) }}"
