...
@section('pageContent')
    ...
    <main>
        <div class="container-xxl flex-grow-1 container-p-y">
            <a class="btn btn-primary mb-3" href="{{ route('nama-undangan-create1', ['id' => $weddingDesign1->id]) }}">+
                Nama
                Undangan</a>
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap p-3">
                    <form id="deleteForm" action="{{ route('nama-undangan.destroy1', ['id' => $weddingDesign1->id]) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        document.getElementById('deleteForm').action =
                            "{{ route('nama-undangan.destroy1', ['id' => ':id']) }}".replace(':id',
                                itemId);
