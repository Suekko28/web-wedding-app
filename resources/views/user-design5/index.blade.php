    ...
    <main>
        <div class="container-xxl flex-grow-1 container-p-y">
            <a class="btn btn-primary mb-3"
                href="{{ route('nama-undangan-create5', [
                    'id' => $weddingDesign5->id, // This is the weddingDesign5 ID (e.g., 2)
                ]) }}">
                + Nama Undangan
            </a>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive text-nowrap p-3">
                        <form id="deleteForm" action="{{ route('nama-undangan.destroy5', ['id' => $weddingDesign5->id]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <div class="btn-group-horizontal">
                                                    <a href="{{ url('nama-undangan/premium-silver/' . $item->id) . '/edit' }}"
        ...
        function updateMessage(radioButton, namaUndangan, slugNamaUndangan, itemId) {
            ...
            if (radioButton === '1') {
                message = "Assalamu'alaikum Wr. Wb\n" +
                    ...
                    "jejakkebahagiaan.com/WDDS5{{ $nomor }}/{!! $slug_nama_pasangan !!}/untuk=" +
                    slugNamaUndangan + "\n\n" +
