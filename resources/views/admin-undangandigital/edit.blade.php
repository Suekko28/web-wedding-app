                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('undangandigital.update', $data->id) }}" method="post"
                        ...
                        <div class="card-body container bg-white mt-5">
                            <div class="mempelai text-center fw-bold fs-5">Undangan Digital</div>
                            <div class="fs-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="kategori" name="kategori">
                                        <option value="0" selected>--Pilih
                                            Kategori--</option>
                                        <option value="1" @if ($data->kategori == '1') selected @endif>Undangan
                                            Pernikahan</option>
                                        <option value="2" @if ($data->kategori == '2') selected @endif>Ulang Tahun
                                        </option>
