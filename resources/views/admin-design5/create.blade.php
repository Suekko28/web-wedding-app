                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('form-design5.store', ['id' => $informasiDesign5Id]) }}" method="post"
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Cover Undangan</div>
                        ...
                        <hr>
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Mempelai Wanita</div>
                        ...
                        <hr>
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Mempelai Pria</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-5 mb-3">
                        ...
                        <hr>
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Perjalanan Cinta</div>
                            <div class="d-flex">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Moment</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-5 mb-3">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Informasi Akad & Resepsi</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-5 mb-3">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Informasi Akad</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-5 mb-3">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Informasi Resepsi</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-5 mb-3">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Live Streaming</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-5 mb-3">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Direct Transfer</div>
                            <div class="d-flex">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai fw-bold fs-5 mb-5">Kirim Hadiah</div>
                            <div class="d-flex">
