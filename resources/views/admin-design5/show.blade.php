...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Show', 'subtitle' => 'Wedding Design 5'])
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form
                        ...
                        @csrf
                        @method('PUT')
                        <input disabled type="hidden" name="informasi_design5_id" value="{{ $informasiDesign5->id }}">
                        <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign5->nama_pasangan }}">
                        <input disabled type="hidden" name="tgl_pernikahan"
                            value="{{ $informasiDesign5->tgl_pernikahan }}">
                            ...
                            <div class="form-group form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="file" class="form-control" id="banner_img"
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="nama_pasangan"
                                            ...
                                            value="{{ $informasiDesign5->nama_pasangan }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="quote"
                                            name="quote" placeholder="Masukkan Quote" value="{{ $data->quote }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="quote_img">Upload Images <span class="mandatory">*</span></label>
                                        <input disabled type="file" class="form-control" id="quote_img"
                                            name="quote_img[]" multiple>
                                        @if ($data->quote_img)
                            ...
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="judul_jadwal"
                                            name="judul_jadwal" placeholder="Judul ucapan pembuka"
                                            value="{{ old('judul', $defaultJudulJadwal) }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="akad_img">Upload Image <span class="fst-italic">
                                                (Opsional)</span></label>
                                        <input disabled type="file" class="form-control" id="akad_img"
                                ...
                                <div class="row">
                                    <div class="col-sm-4 mb-3">
                                        <label for="judul_akad">Judul Akad <span class="fst-italic">
                                                (Opsional)</span></label>
                                        <input disabled type="text" class="form-control" id="judul_akad"
                                            name="judul_akad" value="{{ old('judul_akad', $defaultJudulAkad) }}"
                                            placeholder="Masukkan judul akad">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="tgl_akad">Tanggal Akad <span class="mandatory">*</span></label>
                                        <input disabled type="date" class="form-control" id="tgl_akad"
                                            name="tgl_akad" value="{{ $data->tgl_akad }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="mulai_akad">Mulai Akad <span class="mandatory">*</span></label>
                                        <input disabled type="time" class="form-control" id="mulai_akad"
                                            name="mulai_akad" value="{{ date('H:i', strtotime($data->mulai_akad)) }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input disabled type="text" class="form-control" id="lokasi_akad"
                                            name="lokasi_akad" placeholder="Masukkan lokasi"
                                            value="{{ $data->lokasi_akad }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="deskripsi_akad">Detail<span class="mandatory">*</span></label>
                                        <textarea disabled class="form-control" rows="5" id="deskripsi_akad"
                                            name="deskripsi_akad" placeholder="Masukan alamat">{{ $data->deskripsi_akad }}</textarea disabled>
                                        </div>
                                        <div class="col-sm-4 mb-3">
    ...
    @endforeach
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formPerjalananCinta"
                            ...
                            <input disabled type="hidden" name="wedding_design5_id" value="{{ $informasiDesign5->id }}">
                            <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign5->nama_pasangan }}">
                            <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign5->tgl_pernikahan }}">
        ...
        <script>
            ...
            $(document).on('click', '.Show-btn-perjalanan-cinta', function() {
                ...
                const updateUrl = `/wedding-design5/${id}/update-perjalanan-cinta`;
            ...
            $(document).on('click', '.delete-btn-perjalanan-cinta', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/wedding-design5/${id}/delete-perjalanan-cinta`,
                            type: 'DELETE',
                            data: {
        ...
        <script>
            ...
            $(document).on('click', '.Show-btn-direct-transfer', function() {
                ...
                const updateUrl = `/wedding-design5/${id}/update-direct-transfer`;
            ...
            $(document).on('click', '.delete-btn-direct-transfer', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ url('/wedding-design5') }}/" + id + "/delete-direct-transfer",
                            type: 'DELETE',
                            data: {
                                _token: $('meta[name="csrf-token"]').attr('content')
                            },
        ...
        <script>
            ...
            $(document).on('click', '.Show-btn-kirim-hadiah', function() {
                ...
                const updateUrl = `/wedding-design5/${id}/update-kirim-hadiah`;
            ...
            $(document).on('click', '.delete-btn-kirim-hadiah', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ url('/wedding-design5') }}/" + id + "/delete-kirim-hadiah",
                            type: 'DELETE',
                            data: {
                                _token: $('meta[name="csrf-token"]').attr('content')
                            },
