        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('wedding-design3.update', $data->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input type="file" class="form-control" id="foto_mempelai_perempuan"
                                            ...
                                            value="{{ $data->foto_mempelai_perempuan }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="time" class="form-control" id="mulai_resepsi"
                                            name="mulai_resepsi" placeholder=""
