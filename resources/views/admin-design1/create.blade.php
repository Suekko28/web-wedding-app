        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('wedding-design1.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="file" class="form-control" id="foto_prewedding"
                                            name="foto_prewedding" value="{{ old('foto_prewedding') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai text-center fw-bold fs-5 mb-3">Galeri Foto</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                        ...
                        <div class="card-body container bg-white">
                            <div class="mempelai text-center fw-bold fs-5 mb-4">Cerita Cinta Kami</div>
                            <div class="form-group fs-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="foto_pertemuan">Foto <span
                                                class="fst-italic">(Opsional)</span></label>
                                        <input type="file" class="form-control" id="foto_pertemuan"
                                            name="foto_pertemuan" value="{{ old('foto_pertemuan') }}">
                                    </div>
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea class="form-control" rows="5" id="pertemuan" name="pertemuan"
                                            placeholder="Ceritakan pertemuan kamu dengan pasanganmu">{{ old('pertemuan') }}</textarea>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="foto_pendekatan">Foto <span
                                                class="fst-italic">(Opsional)</span></label>
                                        <input type="file" class="form-control" id="foto_pendekatan"
                                            name="foto_pendekatan" value="{{ old('foto_pendekatan') }}">
                                    </div>
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea class="form-control" rows="5" id="pendekatan" name="pendekatan"
                                            placeholder="Ceritakan pendekatan kamu dengan pasanganmu">{{ old('pendekatan') }}</textarea>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea class="form-control" rows="5" id="lamaran" name="lamaran"
                                            placeholder="Ceritakan lamaran kamu dengan pasanganmu">{{ old('lamaran') }}</textarea>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="foto_pernikahan">Foto <span
                                                class="fst-italic">(Opsional)</span></label>
                                        <input type="file" class="form-control" id="foto_pernikahan"
                                            name="foto_pernikahan" value="{{ old('foto_pernikahan') }}">
                                    </div>
                                    <div class="col-sm-12">
                        ...
                        <div class="card-body container bg-white">
                            ...
                            <div class="form-group fs-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        <label for="nama_rek3">Nama Rek Tertera <span
                                                class="fst-italic">(Opsional)</span></label>
                                        <input type="text" class="form-control" id="nama_rek3" name="nama_rek3"
                                            placeholder="BCA, BRI, Dll" value="{{ old('nama_rek3') }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="no_rek3">No. Rek Tertera <span
                                                class="fst-italic">(Opsional)</span></label>
                                        <input type="text" class="form-control" id="no_rek3" name="no_rek3"
                                            placeholder="Masukkan nomor rekening" value="{{ old('no_rek3') }}">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                        <label for="atas_nama3">Atas Nama <span
                                                class="fst-italic">(Opsional)</span></label>
                                        <input type="text" class="form-control" id="atas_nama3" name="atas_nama3"
                                            placeholder="Rudi Hermawan" value="{{ old('atas_nama3') }}">
                                    </div>
                                    <div class="col-sm-12 mb-3">
                                ...
                                <div class="d-flex flex-row-reverse">
                                    ...
                                    <a href="{{ route('wedding-design1.index') }}" class="btn btn-secondary">Batal</a>
                                </div>
                            </div>
                        </div>
