                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="judul_cerita3"
                                            ...
                                            value="{{ $data->judul_cerita3 }}">
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <label for="foto_lamaran">Foto <span class="fst-italic">(Opsional)</span></label>
                                        <input type="file" class="form-control" id="foto_lamaran"
                                            name="foto_lamaran">
                                    </div>
                                    <div class="col-sm-12 mb-3">
