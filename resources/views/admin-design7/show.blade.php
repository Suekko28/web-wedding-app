...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Show', 'subtitle' => 'Wedding Design 7'])
    ...
    @php
        ...
        $defaultNamaPenutup = $informasiDesign7->nama_pasangan;
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form
                        ...
                        @csrf
                        @method('PUT')
                        <input disabled type="hidden" name="informasi_design7_id" value="{{ $informasiDesign7->id }}">
                        <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign7->nama_pasangan }}">
                        <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign7->tgl_pernikahan }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        <label for="zona_waktu_akad">Zona Waktu <span
                                                class="mandatory">*</span></label>
                                        <select disabled class="form-control" name="zona_waktu_akad" id="zona_waktu_akad"disabled>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        <label for="zona_waktu_resepsi">Zona Waktu <span
                                                class="mandatory">*</span></label>
                                        <select disabled class="form-control" name="zona_waktu_resepsi" id="zona_waktu_resepsi" disabled>
                                            <option value="0" disabled
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formDirectTransfer"
                        ...
                        <input disabled type="hidden" name="wedding_design7_id" value="{{ $informasiDesign7->id }}">
                        <input disabled type="hidden" name="nama_pasangan" value="{{ $informasiDesign7->nama_pasangan }}">
                        <input disabled type="hidden" name="tgl_pernikahan" value="{{ $informasiDesign7->tgl_pernikahan }}">
