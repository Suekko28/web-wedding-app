...
<body>
    ...
    @if (!session('hide_offcanvas'))
        <div class="offcanvas offcanvas-top show" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
            ...
            <div class="offcanvas-body">
                ...
                <img class="background-offcanvas object-fit-cover" src="{{ asset('img/design-7/background.jpg') }}"
                    alt="background">
    ...
    <img class="background-template object-fit-cover" src="{{ asset('img/design-7/background.jpg') }}"
        alt="background">
    <!-- HERO -->
