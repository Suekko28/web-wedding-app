                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="btn-group-horizontal">
                                        ...
                                        <a class="btn btn-primary mb-2 {{ !$item->KontenDesign9->first() || !$item->KontenDesign9->first()->nama_mempelai_laki || !$item->KontenDesign9->first()->nama_mempelai_perempuan ? 'disabled' : '' }}"
                                            href="{{ route('wedding-design9-home-preview', [
                                                 'slug_nama_mempelai_laki' => Str::slug($item->KontenDesign9->first()->nama_mempelai_laki ?? 'Unknown'),
                                                 'slug_nama_mempelai_perempuan' => Str::slug($item->KontenDesign9->first()->nama_mempelai_perempuan ?? 'Unknown'),
                                             ]) }}"
                                            target="_blank">
