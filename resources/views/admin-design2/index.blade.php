...
@section('pageContent')
    ...
    <div class="card w-100 position-relative overflow-hidden">
        ...
        <div class="card-body">
            <a class="btn btn-primary mb-3" href="{{ url('wedding-design2/create') }}">+ Buat Undangan</a>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="btn-group-horizontal">
                                        <a href="{{ url('wedding-design2/' . $item->id) . '/edit' }}"
                                        ...
                                        <a href="{{ route('wedding-design2.show', ['wedding_design2' => $item->id]) }}"
