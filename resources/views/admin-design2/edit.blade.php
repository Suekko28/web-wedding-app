...
@section('pageContent')
    ...
    @include('layouts.breadcrumb', ['title' => 'Edit', 'subtitle' => 'Wedding Design 2'])
        ...
        <div class="card-body">
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('wedding-design2.update', $data->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="file" class="form-control" id="background_img" name="background_img"
                                            placeholder="" value={{ $data->background_img }}>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="file" class="form-control" id="banner_img" name="banner_img"
                                            placeholder="" value={{ $data->banner_img }}>
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="file" class="form-control" id="foto_prewedding"
                                            name="foto_prewedding" placeholder="" value={{ $data->foto_prewedding }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_cerita1" name="tgl_cerita1"
                                            placeholder="" value={{ $data->tgl_cerita1 }}>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_cerita2" name="tgl_cerita2"
                                            placeholder="" value={{ $data->tgl_cerita2 }}>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_cerita3" name="tgl_cerita3"
                                            placeholder="" value={{ $data->tgl_cerita3 }}>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_cerita4" name="tgl_cerita4"
                                            placeholder="" value={{ $data->tgl_cerita4 }}>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="time" class="form-control" id="mulai_akad" name="mulai_akad"
                                            placeholder="" value="{{ date('H:i', strtotime($data->mulai_akad)) }}">
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="time" class="form-control" id="mulai_resepsi"
                                            name="mulai_resepsi"
                                            placeholder=""value="{{ date('H:i', strtotime($data->mulai_resepsi)) }}">
                                    </div>
