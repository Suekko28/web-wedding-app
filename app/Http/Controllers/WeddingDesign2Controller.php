...
class WeddingDesign2Controller extends Controller
{
    ...
    public function store(WeddingDesign2FormRequest $request)
    {
        ...
        if ($request->hasFile('background_img')) {
            $data['background_img'] = $request->file('background_img')->storeAs('public/wedding-design2', $request->file('background_img')->getClientOriginalName());
        }

        if ($request->hasFile('banner_img')) {
            $data['banner_img'] = $request->file('banner_img')->storeAs('public/wedding-design2', $request->file('banner_img')->getClientOriginalName());
        }

        if ($request->hasFile('foto_prewedding')) {
            $data['foto_prewedding'] = $request->file('foto_prewedding')->storeAs('public/wedding-design2', $request->file('foto_prewedding')->getClientOriginalName());
        }

        if ($request->hasFile('foto_mempelai_laki')) {
            $data['foto_mempelai_laki'] = $request->file('foto_mempelai_laki')->storeAs('public/wedding-design2', $request->file('foto_mempelai_laki')->getClientOriginalName());
        }

        if ($request->hasFile('foto_mempelai_perempuan')) {
            $data['foto_mempelai_perempuan'] = $request->file('foto_mempelai_perempuan')->storeAs('public/wedding-design2', $request->file('foto_mempelai_perempuan')->getClientOriginalName());
        }

        if ($request->hasFile('music')) {
            $data['music'] = $request->file('music')->storeAs('public/wedding-design2-music', $request->file('music')->getClientOriginalName());
        }
        ...
        foreach (range(1, 6) as $index) {
            ...
            if ($request->hasFile($galeri_field)) {
                $data[$galeri_field] = $request->file($galeri_field)->storeAs('public/wedding-design2', $request->file($galeri_field)->getClientOriginalName());
            } else {
        ...
        return redirect()->route('wedding-design2')->with('success', 'Berhasil menambahkan data');
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('wedding-design2')->with('success', 'Data berhasil diperbarui.');
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('wedding-design2')->with('success', 'Data berhasil Dihapus');
    }
}
