...
class WeddingDesign8FormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'informasi_design8_id' => ['required', 'exists:informasi_design8,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'informasi_design8_id.required' => 'Informasi design harus diisi.',
            'informasi_design8_id.exists' => 'Informasi design tidak valid.',
        ];
    }
}
