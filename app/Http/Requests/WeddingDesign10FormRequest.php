...
class WeddingDesign10FormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'instagram_streaming' => ['nullable', 'max:255'],
            'youtube_streaming' => ['nullable', 'max:255'],
            'zoom_streaming' => ['nullable', 'max:255'],
            'informasi_design10_id' => ['required', 'exists:informasi_design10,id'],
            ...
            'judul_quote' => ['string', 'nullable', 'max:255'],
            'deskripsi_quote' => ['string', 'nullable'],
        ...
        if ($method === 'POST') {
            ...
            $rules['image_hero'] = ['nullable', 'array']; // Change to array
            $rules['image_hero.*'] = ['image', 'mimes:jpeg,png,jpg']; // Validate each image
            ...
            $rules['foto_mempelai_perempuan'] = ['nullable', 'image', 'mimes:jpeg,png,jpg'];
            $rules['foto_mempelai_laki'] = ['nullable', 'image', 'mimes:jpeg,png,jpg'];
            $rules['image_hero'] = ['nullable', 'array'];
            $rules['image_hero.*'] = ['image', 'mimes:jpeg,png,jpg'];
    ...
    public function messages(): array
    {
        return [
            ...
            'image_hero.array' => 'Hero harus berupa array gambar.',
            'image_hero.*.image' => 'Setiap gambar pada hero harus berupa file gambar.',
            'image_hero.*.mimes' => 'Gambar hero hanya boleh berupa file dengan format jpeg, png, jpg.',

            'image_cinta.*.image' => 'Setiap gambar pada cinta harus berupa file gambar.',
            'image_cinta.*.mimes' => 'Gambar cinta hanya boleh berupa file dengan format jpeg, png, jpg.',

            'judul_resepsi.max' => 'Judul resepsi tidak boleh lebih dari 255 karakter.',
            'judul_quote.max' => 'Judul quote tidak boleh lebih dari 255 karakter.',
            'judul_jadwal.required' => 'Judul jadwal harus diisi.',
            'judul_jadwal.max' => 'Judul jadwal tidak boleh lebih dari 255 karakter.',

            'judul_akad.max' => 'Judul akad tidak boleh lebih dari 255 karakter.',

            'deskripsi_quote.string' => 'Deskripsi quote harus berupa teks.',
            ...
            'informasi_design10_id.required' => 'Informasi design harus diisi.',
            'informasi_design10_id.exists' => 'Informasi design tidak valid.',
        ];
    }
}
