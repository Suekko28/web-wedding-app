...
class WeddingDesign7FormRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'informasi_design7_id' => ['required', 'exists:informasi_design7,id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'informasi_design7_id.required' => 'Informasi design harus diisi.',
            'informasi_design7_id.exists' => 'Informasi design tidak valid.',
        ];
    }
}
